  ...
  "groups": [
    {
      ...
      "chatbot": {
        ...
        "contextualTriggerMinMessagesBetween": 100,
        "enableThinking": true,
        "thinkingBudget": 2000,
...
| `contextualTriggerMinMessagesBetween` | `100` | Minimum non-bot messages that must be observed since the last context-based reply before another one is allowed; persisted under `logs/` so it survives restarts |
